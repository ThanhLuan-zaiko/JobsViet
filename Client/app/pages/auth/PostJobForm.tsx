      ...
      axios.get(`${import.meta.env.VITE_API_BASE_URL}/jobs/${editJobId}`)
        .then(res => {
          ...
          if (job.postedByUserId !== user.userId) {
            setNotification({ message: "Bạn không có quyền chỉnh sửa tin này.", type: "warning" });
          ...
          setFormData({
            ...
            genderPreference: job.genderPreference || "Không yêu cầu",
        ...
        .catch(err => {
          setNotification({ message: "Không thể tải thông tin công việc.", type: "error" });
          navigate("/manage-jobs");
        })
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <p className="text-lg font-semibold text-gray-700 mb-2">
                  {isDragActive ? "Thả ảnh vào đây..." : "Kéo thả hoặc click để tải ảnh lên"}
                </p>
